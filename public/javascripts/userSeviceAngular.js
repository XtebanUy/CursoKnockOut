...
(function () {
	var app = angular.module("mainApp.storageModule", []);

	app.factory('sevicesStorage', ['$q', function ($q) {
		var databaseDeferred = $q.defer();
		var promise = databaseDeferred.promise;
		var persistence = {};
